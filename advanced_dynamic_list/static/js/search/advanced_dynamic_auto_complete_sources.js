odoo.define('advanced_dynamic_list.auto_compelte_sources', function (require) {
    "use strict";
    ...
    var AutoCompeleteBase = Class.extend(mixins.EventDispatcherMixin, {
        completion_label: "%s",
    ...
    var Field = AutoCompeleteBase.extend(ServicesMixin, {
        default_operator: '=',
        /**
         * @override
         * @param {Object} field
    ...
    var ManyToOneField = CharField.extend({
        ...
        getAutocompletionValues: function (value) {
            ...
            // }]);
            // default expand the values, as there is just one filter
